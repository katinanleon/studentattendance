...
<h2></h2>
  ...
  <div class="container">
    <div class="row">
            ...
            <div class="col"> <!-- block formulaire-->
                   ...
                   <section>
                    <form class="border p-2 mt-1 border-dark justify-content-center">
                      <div class="">
                          <div class="col mb-3">
                              <label for="email" class="form-label text-bold text-warning">email</label>
         ...
         <div class="row">
         <div class="col-4"></div>
         <div class="col-4 border p-2 mt-1 border-dark justify-content-center"><a href="register.php">Inscrivez-vous</a></div>
         <div class="col-4"></div> 
         </div>
